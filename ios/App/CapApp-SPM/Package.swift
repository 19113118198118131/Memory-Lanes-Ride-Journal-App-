...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorBackgroundRunner", path: "../../../node_modules/.pnpm/@capacitor+background-runner@3.0.0_@capacitor+core@8.4.1/node_modules/@capacitor/background-runner"),
