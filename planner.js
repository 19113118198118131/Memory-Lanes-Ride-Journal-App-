...
import { generateLoopCandidates, targetDistanceKm, formatMinutes, buildWhyBullets, buildCautions, MOOD_LABELS } from './planner-engine.js?v=89';
import { buildRecommender } from './ai/recommender.js?v=89';
