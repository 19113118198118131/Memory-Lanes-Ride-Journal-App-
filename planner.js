...
import { generateLoopCandidates, targetDistanceKm, formatMinutes, buildWhyBullets, buildCautions, MOOD_LABELS } from './planner-engine.js?v=82';
import { buildRecommender } from './ai/recommender.js?v=82';
