...
import { analyzeRide, renderRiderSkills, summarizeForStorage } from './riderskills.js?v=57';
import { buildRideInsights } from './insights.js?v=57';
import { mlIconSVG } from './icons.js?v=57';
