...
import { analyzeRide, renderRiderSkills, summarizeForStorage } from './riderskills.js?v=56';
import { buildRideInsights } from './insights.js?v=56';
import { mlIconSVG } from './icons.js?v=56';
